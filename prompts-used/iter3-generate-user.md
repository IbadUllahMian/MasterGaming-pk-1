PRIMARY CONVERSION GOAL (build the site's main CTA around this): signup — people fill out a form to join Free Fire tournaments
Build a website for MasterGaming.pk, a Free Fire tournament platform inspired by gamerzone.pk. The website is for esports teams. The main goal is for people to fill out a form to join Free Fire tournaments. Include sections for Upcoming tournaments, Leaderboard, Results, Prize rules, Team signup form. Tournament entry is paid entry with manual confirmation. Each tournament should show: Entry fee, Prize pool, Match time, Squad format, Registration deadline. Include trust signals: Past winners, Live leaderboard, Clear rules, Prize proof, Team testimonials. Create one logo for the brand. Use a premium tournament style with a dark competitive theme, polished esports branding, strong hierarchy, large stat blocks, and a more serious pro-level feel.

## Build requirements

- Build me a gaming website like gamerzone.pk.
- Free Fire tournaments.
- Tournament site + results and leaderboard pages.
- The user wants a website where people can play Free Fire tournaments, and the user can earn money from them, and the winners can also earn money from it.
- Players should join tournaments by filling out a form.
- The website is mainly for esports teams.
- Website/brand name: MasterGaming.pk
- Create one logo.
- Sections: Upcoming tournaments, Leaderboard, Results, Prize rules, Team signup form.
- The user wants your recommendation for the visual vibe/design direction.
- Tournament entry: Paid entry with manual confirmation.
- Contact form submissions should go to ibadullahmian6@gmail.com.
- Each tournament should show: Entry fee, Prize pool, Match time, Squad format, Registration deadline.
- Trust signals to include: Past winners, Live leaderboard, Clear rules, Prize proof, Team testimonials.
