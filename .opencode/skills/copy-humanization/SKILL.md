...
description: >
  Use this skill when polishing drafted user-facing prose to remove AI-writing
  patterns — for example "make this sound human", "remove the AI tone", "less
  robotic", or "tighten this draft". Apply it to website, email, social, and
  report copy. Use `website-copywriting` when the task also needs website value
  propositions, proof, section strategy, or calls to action.
mode: both
---
...
voice page wins for that element. Use these rules while drafting, then use
the catalog as the final audit; when a summary rule and a more specific
catalog entry differ, follow the catalog entry.
